...
// ✅ Properly defined Checkbox as a React Component
...
// ✅ Properly defined RadioButton as a React Component
...
const AllRooms = () => {
  ...
  const handlePriceChange = (checked, label) => {
    if (checked) {
      ...
      setSelectedPriceRange(selectedPriceRange.filter((item) => item !== label));
    }
  };

  const handleSortChange = (_checked, label) => {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        {roomsDummyData.map((room) => (
          ...
          >
            ...
            <div className='md:w-1/2 flex flex-col gap-2'>
              ...
              {/* Price */}
              <p className='text-1 font-medium text-gray-700'>${room.pricePerNight}/night</p>
            </div>
          </div>
        ))}
      </div>
      ...
      {/* Filters Sidebar */}
      <div className='bg-white border border-gray-300 text-gray-700 rounded-lg p-4 w-full lg:w-80 max-lg:mb-8 min-lg:mt-16'>

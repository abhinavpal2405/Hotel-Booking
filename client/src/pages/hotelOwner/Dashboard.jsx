  ...
  return (
    <div>
      ...
      <div className="flex gap-4 my-8 flex-wrap">
        {/* Total Booking */}
        <div className="bg-primary/30 border border-primary/10 rounded flex p-4 pr-8 items-center">
      ...
      <div className='w-full max-w-3x text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll'>
